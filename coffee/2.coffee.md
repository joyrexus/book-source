...
The operation of mapcat is such that when the mapped function returns an array,
it can be flattened a level. We could then use mapcat and another function,
butLast, to define a third function, interpose:
